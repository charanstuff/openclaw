          ...
          [
            {
              ...
              "extract": true,
              "stripComponents": 1,
              "label": "Install GitHub CLI (Linux amd64)",
            },
          ],
      },
  }
...
- After install, ensure the skill tools `bin` directory is in PATH (e.g. add to `tools.exec.pathPrepend` in OpenClaw config).
